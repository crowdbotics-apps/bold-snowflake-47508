"""
Django settings for bold_snowflake_47508 project.
...
ROOT_URLCONF = 'bold_snowflake_47508.urls'
...
WSGI_APPLICATION = 'bold_snowflake_47508.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "bold_snowflake_47508 API",
    "DESCRIPTION": "API documentation for bold_snowflake_47508 App",
    "VERSION": "v1",
}
